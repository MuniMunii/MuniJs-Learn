...
const person = {
    ...
    getPersonInfo:function(){
        console.log(`${this.firstName} ${this.lastName} Lives In ${this.country} He is ${this.age} Old he is ${this.job}. He teaches ${this.skills}.He Speak ${this.languages[0,1]} and little bit of ${this.languages[this.languages.length-1]}`);
    }
  }

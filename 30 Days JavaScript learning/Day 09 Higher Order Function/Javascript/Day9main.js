...
// No 3
const printCountriesForEach=countries.forEach(country=>
    console.log(country)
);
...
// No 31
function tenFirstCountries(Country) {
    const tenCountry=Country
    .sort()
    .slice(0,10);
    return tenCountry;
}
console.log(tenFirstCountries(allCountries));
...
const statistics={
    ...
    // JSON.Stringfy agar format array/Object nya menjadi string dan tanpa mengubah bentuk [] dan elemen di dalam nya
